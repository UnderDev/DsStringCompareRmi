...
<div class="animated bounceInDown"
	style="font-size: 48pt; font-family: arial; color: #990000; font-weight: bold">String
		...
		<td valign="top">
			...
			<form bgcolor="white" method="POST" action="doProcess">
				<fieldset>
					...
					<b>Select Algorithm:</b> <select name="cmbAlgorithm">
